...
https://github.com/bitcoin/bitcoin/issues/17326[Issue 17326^] proposed persisting the node's outbound block-relay-only connection list to disk, and on restart reconnecting to the same peers.
